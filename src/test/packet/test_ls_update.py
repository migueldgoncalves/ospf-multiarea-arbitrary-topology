...
class TestLSUpdate(unittest.TestCase):
    ...
    def test_unpack_packet(self):
        ...
        self.assertEqual(2, unpacked_body.lsa_list[4].header.ls_type)
        ...
        self.assertEqual(2, unpacked_body.lsa_list[5].header.ls_type)
        ...
        self.assertEqual(9, unpacked_body.lsa_list[7].header.ls_type)
        ...
        self.assertEqual(1, unpacked_body.lsa_list[7].body.referenced_ls_type)
        ...
        self.assertEqual(9, unpacked_body.lsa_list[8].header.ls_type)
        ...
        self.assertEqual(2, unpacked_body.lsa_list[8].body.referenced_ls_type)
        ...
        self.assertEqual(9, unpacked_body.lsa_list[9].header.ls_type)
        ...
        self.assertEqual(1, unpacked_body.lsa_list[9].body.referenced_ls_type)
        ...
        self.assertEqual(9, unpacked_body.lsa_list[10].header.ls_type)
        ...
        self.assertEqual(2, unpacked_body.lsa_list[10].body.referenced_ls_type)
        ...
        self.assertEqual(9, unpacked_body.lsa_list[11].header.ls_type)
        ...
        self.assertEqual(1, unpacked_body.lsa_list[11].body.referenced_ls_type)
        ...
        self.assertEqual(9, unpacked_body.lsa_list[12].header.ls_type)
        ...
        self.assertEqual(2, unpacked_body.lsa_list[12].body.referenced_ls_type)
