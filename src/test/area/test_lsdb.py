...
class TestLsdb(unittest.TestCase):
    ...
    def test_get_lsa(self):
        ...
        retrieved_lsdb = self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])
        ...
        retrieved_headers = self.lsdb_ospfv2.get_lsa_headers([self.interface_ospfv2])
    ...
    def test_delete_lsa(self):
        ...
        self.assertEqual(2, len(self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])))
        self.lsdb_ospfv2.delete_lsa(1, '1.1.1.1', '1.1.1.1', [self.interface_ospfv2])
        self.assertEqual(1, len(self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])))
        self.assertEqual(2, self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])[0].header.ls_type)
        self.lsdb_ospfv2.delete_lsa(1, '1.1.1.1', '1.1.1.1', [self.interface_ospfv2])
        self.assertEqual(1, len(self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])))
        self.lsdb_ospfv2.delete_lsa(2, '222.222.3.2', '2.2.2.2', [self.interface_ospfv2])
        self.assertEqual(0, len(self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])))

        self.lsdb_ospfv3.delete_lsa(1, '0.0.0.0', '0.0.0.0', [self.interface_ospfv3])
        ...
        self.lsdb_ospfv3.delete_lsa(9, '0.0.0.0', '2.2.2.2', [self.interface_ospfv3])
        self.lsdb_ospfv3.delete_lsa(8, '0.0.0.4', '1.1.1.1', [self.interface_ospfv3])
        self.assertEqual(0, len(self.lsdb_ospfv3.get_lsdb([self.interface_ospfv3])))
    ...
    def test_add_lsa(self):
        ...
        self.assertEqual(1, len(self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])))
        self.assertEqual(1, self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])[0].header.ls_type)
        self.assertEqual(2147483654, self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])[0].header.ls_sequence_number)
        ...
        self.assertEqual(1, len(self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])))
        self.assertEqual(1, self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])[0].header.ls_type)
        self.assertEqual(10000, self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])[0].header.ls_sequence_number)
        ...
        self.assertEqual(2, len(self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])))
        self.assertEqual('1.1.1.1', self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])[0].header.link_state_id)
        self.assertEqual('4.4.4.4', self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])[1].header.link_state_id)
        self.lsdb_ospfv2.add_lsa(self.lsa_ospfv2_2)
        self.assertEqual(3, len(self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])))
        self.assertEqual(2, self.lsdb_ospfv2.get_lsdb([self.interface_ospfv2])[2].header.ls_type)
        ...
        self.assertEqual(2, len(self.lsdb_ospfv3.get_lsdb([self.interface_ospfv3])))
        self.assertEqual('0.0.0.0', self.lsdb_ospfv3.get_lsdb([self.interface_ospfv3])[0].header.link_state_id)
